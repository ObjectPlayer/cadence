...
func main() {
	...
	pathToBin := "/Users/supun/work/cadence/runtime/main/main"
	cmd := exec.Command(pathToBin, "runScript2")
	...
	if err == nil {
		...
		// TODO: ideally shouldn't have stderr
		return
	}
	...
	if ok && exitError.Exited() && exitError.ExitCode() == 1 {
		// Gracefully handled errors. They exit with an exit-code 1
		// and the error content is serialized to stderr.
